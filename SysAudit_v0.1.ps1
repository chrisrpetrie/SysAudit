...
.NOTES
  ...
  Purpose/Change: Increased functions added and minor improvements
...
"@
    Write-Host "[i] Running Computer Audit Tool ..`n"
...
$RDPNLA = $RDPNLA -replace '<td>2</td>','<td class="Compliant">2</td>'
